...
* b-7.4.x branch is compatible with OXID eShop compilation version 7.4.x
...
In case you are updating your module from v3.0.x (which is compatible with OXID eShop 7.0.x) to OXID eShop 7.1.x
compatible module version, please run “**composer require oxid-esales/evat-module ^4.0.0 --with-all-dependencies**”
