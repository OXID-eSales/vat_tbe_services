...
use OxidEsales\EVatModule\Model\Evidence\Item\oeVATTBEEvidence;
use OxidEsales\EVatModule\Model\oeVATTBEList;
...
class oeVATTBEEvidenceList extends oeVATTBEList
{
    ...
    public function add($oItem)
    {
        if (!($oItem instanceof oeVATTBEEvidence)) {
            ...
            $oException = oxNew(StandardException::class, 'Item must be instance or child of oeVATTBEEvidence');
            throw $oException;
        }
