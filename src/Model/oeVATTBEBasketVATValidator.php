...
use OxidEsales\EVatModule\Shop\oeVATTBEOxUser;
...
{
    /** @var oeVATTBEOxBasket|Basket  */
    private $_oBasket;

    /** @var User|oeVATTBEOxUser */
    private $_oUser;
     ...
     */
    public function __construct(Basket $oBasket, User $oUser, oeVATTBETBEUser $oTBEUserCountry)
    {
    ...
    public static function createInstance()
    {
        ...
        $oValidator = oxNew(oeVATTBEBasketVATValidator::class, $oBasket, $oUser, $oTBEUserCountry);
    ...
    public function isArticleValid($oBasketItem)
    {
        ...
        /** @var Article|oeVATTBEOxArticle $oArticle */
     ...
     *
     * @return oeVATTBEOxBasket|Basket
     */
