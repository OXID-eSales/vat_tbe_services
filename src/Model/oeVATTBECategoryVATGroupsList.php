...
use OxidEsales\EVatModule\Model\DbGateway\oeVATTBECategoryVATGroupsDbGateway;
...
class oeVATTBECategoryVATGroupsList extends oeVATTBEModel
{
    ...
    {
        $oGateway = oxNew(oeVATTBECategoryVATGroupsDbGateway::class);
        $oList = oxNew(oeVATTBECategoryVATGroupsList::class, $oGateway);
