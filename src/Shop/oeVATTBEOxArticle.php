...
{
    /** @var oeVATTBETBEArticleCacheKey */
    ...
    protected function _getOeVATTBETBEArticleCacheKey()
    {
        if (!$this->_oVATTBEArticle) {
            $this->_oVATTBEArticle = oxNew(oeVATTBETBEArticleCacheKey::class, $this->getUser());
        }
    ...
    protected function _getOeVATTBETBEArticleSqlBuilder()
    {
        if (is_null($this->_oVATTBEArticleSQLBuilder)) {
            $this->_oVATTBEArticleSQLBuilder = oxNew(oeVATTBEArticleSQLBuilder::class, $this);
        }
